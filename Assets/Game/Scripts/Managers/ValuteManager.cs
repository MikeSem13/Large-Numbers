...
public class ValuteManager : MonoBehaviour
{
   ...
   public void ConvertValuteToText(ValuteModel valuteModel)
   {
      ...
      else if (valuteModel.ValueModels[valuteModel._NumberOfValue].Valute >= 0 && valuteModel._NumberOfValue > 0 && valuteModel.ValueModels[valuteModel._NumberOfValue - 1].Valute / 100 >= 1)
      {
